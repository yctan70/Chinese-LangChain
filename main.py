...
class LangChainCFG:
    ...
    vector_store_path = '/content/MyDrive/cache'
    docs_path = './docs'
    kg_vector_stores = {
        'emotion': '/content/MyDrive/cache/emotion',
        '中文维基百科': '/content/MyDrive/cache/zh_wikipedia',
        '大规模金融研报': '/content/MyDrive/cache/financial_research_reports',
        '初始化': '/content/MyDrive/cache/cache',
